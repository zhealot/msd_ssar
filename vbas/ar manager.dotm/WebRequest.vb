...
' @type Dictionary
''
Public UrlSegments As Scripting.Dictionary
...
Public Sub AddBodyParameter(Key As Variant, Value As Variant)
    If VBA.IsEmpty(web_pBody) Then
        Set web_pBody = New Scripting.Dictionary
...
''
Public Sub CreateFromOptions(Options As Scripting.Dictionary)
...
Private Sub Class_Initialize()
    ...
    Set Me.UrlSegments = New Scripting.Dictionary
